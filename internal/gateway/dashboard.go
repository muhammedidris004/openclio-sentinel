...
func (h *Handlers) Overview(w http.ResponseWriter, r *http.Request) {
	...
	memorySummary := memoryserving.DefaultEAMRuntimeMetrics().Snapshot()
	toolSummary := map[string]any{
		...
		"exec_profile":       "",
		"approval_on_block":  false,
		"allowed_tools":      []string{},
	}
	if h.cfg != nil {
		toolSummary["packs"] = h.cfg.Tools.Packs
		toolSummary["mcp_presets"] = h.cfg.Tools.MCPPresets
		toolSummary["exec_profile"] = h.cfg.Tools.Exec.Profile
		toolSummary["approval_on_block"] = h.cfg.Tools.Exec.ApprovalOnBlock
		toolSummary["allowed_tools"] = h.cfg.Tools.AllowedTools
		toolSummary["mcp_servers"] = len(h.cfg.MCPServers)
		active := 0
		...
		toolSummary["mcp_servers_active"] = active
	}
