...
type ChatRequest struct {
	...
	// For Anthropic: sends a thinking block with budget_tokens = ThinkingBudget.
	// For OpenAI o1/o3/o4-mini: sends reasoning_effort = "medium" (or high if budget > 15000).
	Thinking       bool `json:"thinking,omitempty"`
	ThinkingBudget int  `json:"thinking_budget,omitempty"` // tokens; 0 defaults to 8000
}
